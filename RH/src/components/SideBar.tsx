...
export const SideBar: FunctionComponent = () => {
  ...
  return (
    <aside className="flex flex-col items-center p-4 rounded-r-xl bg-teal-500 justify-between">
      <ul className={`flex flex-col gap-3 text-white ${isOpen ? "w-52":"w-12"} transition-all      `}>
        ...
        <li className="flex text-2xl hover:bg-white/20 p-3 rounded-lg hover:backdrop-blur-xl items-center gap-3">
          <FiBriefcase />
          {
