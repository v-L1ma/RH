    ...
    return(
        <aside className="flex flex-col w-1/6 items-center p-3 rounded-r-xl bg-white">
                <div className="flex items-center">
                    ...
                    <ul>
                        <li className="mt-10 flex items-center text-xl" onClick={()=>setDropDownListOpen(!dropDownListOpen)}><MdOutlineKeyboardArrowDown/> Recrutamento e seleção</li>
                        {
                            dropDownListOpen &&
                            <ul className="mt-5 ml-7 flex flex-col gap-5 ">                    
                            <li>Gestão de Candidatos
                            </li>
